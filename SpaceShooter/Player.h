...
public:
	...
	void init(Position position, float speed, Input* input);
	void update(short screenWidth, short screenHeight, float deltaTime);
	...
	Position getStartPosition() { return this->m_startPosition; }
